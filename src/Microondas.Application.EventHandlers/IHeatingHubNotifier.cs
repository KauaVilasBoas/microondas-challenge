...
{
    Task NotifyHeatingStartedAsync(Guid sessionId, int totalSeconds, int powerLevel,
        CancellationToken cancellationToken = default);

    Task NotifyHeatingTickedAsync(Guid sessionId, int remainingSeconds, string displayTime, string currentOutput,
        CancellationToken cancellationToken = default);
    ...
    Task NotifyHeatingTimeAddedAsync(Guid sessionId, int addedSeconds, int newRemainingSeconds,
        CancellationToken cancellationToken = default);
}